...
function BrandMark({ size = 28, inverted = false, monochrome = false }) {
...
function BrandWord({ size = 17, color = "var(--fg1)" }) {
  return (
    <span style={{
...
function PromptSmile({ size = 24, color = "var(--color-accent)" }) {
  return (
    <span style={{
      fontFamily: "var(--font-mono)", fontWeight: 700,
...
Object.assign(window, { BrandMark, BrandWord, PromptSmile });
