...
// The design components are React (ported from the Claude Design handoff in
// design/). They are rendered SERVER-SIDE ONLY at build time — no client
